...
impl<'a, T: FnMut() -> CallbackReturnStatus, CB: Grammar> GrammarParser<'a, T, CB> {
    pub fn format_define(&mut self, end_token: TokenType) {
        /*
         * 处理如: a is math::Get
         * env:
    ...
    fn format_define_id(&mut self, end_token: TokenType) {
    ...
    fn format_define_end_single(&mut self, name: String) {
    }

    fn format_define_end_multi(&mut self, first: String) {
